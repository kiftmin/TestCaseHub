...
export const DEFECT_TRANSITIONS: Record<string, readonly string[]> = {
  ...
  assign: ["TRIAGED"],
  "flag-blocked": ["NEW", "TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED", "BLOCKED", "RESOLVED_DEV", "QA_PASSED", "PENDING_BIZ_ACCEPTANCE", "READY_FOR_VERIFICATION"],
  "flag-retest-from-new": ["NEW", "TRIAGED", "ASSIGNED", "IN_PROGRESS", "BLOCKED", "REGRESSED", "QA_PASSED"],
  "submit-for-business-decision": ["NEW", "TRIAGED", "ASSIGNED", "IN_PROGRESS", "RESOLVED_DEV", "QA_PASSED", "REGRESSED", "READY_FOR_VERIFICATION"],
  start: ["ASSIGNED"],
  block: ["TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED"],
  unblock: ["TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED", "BLOCKED"],
  ...
  "reschedule-retest": ["READY_FOR_VERIFICATION"],
  "reject-verification": ["READY_FOR_VERIFICATION"],
  regress: ["CLOSED", "PASSED_BY_AGREEMENT"],
  "retry-after-regression": ["REGRESSED"],
  reassign: ["ASSIGNED", "IN_PROGRESS"],
  "accept-by-agreement": ["PENDING_BIZ_ACCEPTANCE"],
