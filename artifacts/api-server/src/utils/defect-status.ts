...
export const DEFECT_TRANSITIONS: Record<string, readonly string[]> = {
  ...
  assign: ["TRIAGED"],
  "flag-blocked": ["NEW", "TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED", "RESOLVED_DEV", "QA_PASSED", "PENDING_BIZ_ACCEPTANCE", "READY_FOR_VERIFICATION"],
  "flag-retest-from-new": ["NEW", "TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED", "QA_PASSED"],
  ...
  unblock: ["TRIAGED", "ASSIGNED", "IN_PROGRESS", "REGRESSED"],
